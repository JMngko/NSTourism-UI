    ...
    <script>
        ...
        function initMap() {
            map = new google.maps.Map(document.getElementById('map'), {
              center: {lat: 2.647096, lng: 125.407982},
              zoom: 8
            });
        ...
        async function getMarker(map) {
            try {
                var apiUri = 'http://localhost/nstourism/mapsjson3.php?id=<?php echo $_GET['id']; ?>'
                ...
                markers.forEach(function(entry) {
                    ...
                    var contentString = '<div style="width: 200px">'+
                        ...
                        '<font size="2">'+entry.deskripsi+'</font><br>'+
                        // '<a href="wisata_details.php?id='+entry.id_wisata+'"><img src="admin/admin/'+entry.gambarx+'" width="200px"></a>'+
                        '</div>';
