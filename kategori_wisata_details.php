        ...
        <section id="items-grid">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!--Item-->
                    <?php 
                        $sqlx = mysqli_query($con, "SELECT * FROM wisata WHERE kategori = '$data[nama_kategori]'");
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card ts-item ts-card ts-item__lg">
                            ...
                            <!--Card Image-->
                            <a href="wisata_details.php?id=<?php echo $datax['id_wisata']; ?>" class="card-img ts-item__image" data-bg-image="admin/admin/<?php echo $datax['gambar']; ?>">
                
                                <figure class="ts-item__info">
                                    <h4><?php echo $datax['nama_wisata']; ?></h4>
                                    <aside>
                                        <i class="fa fa-map-marker mr-2"></i>
                                        <?php echo $datax['alamat']; ?>
                                    </aside>
                                </figure>
                            </a>
